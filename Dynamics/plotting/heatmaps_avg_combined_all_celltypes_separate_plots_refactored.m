...
set(f,'Units','inches', 'Position', [1,1,2.9,1.8]); %[100 100 170 216]

%%% CHANGED: create 4 equal axes based on the figure size
ax_all = equalSubplotsFromFigure(f, 3, 1);
...
adjust_y_label_position(1,1:3,0);
...
addScaleBar(gca, 30, "1 s", [], [],'XOffsetFrac', 0.025,'LabelOffsetFrac', 0.01);
