...
[info, alignment, plot_info, bin_size,imaging_st,all_celltypes] = get_alignment_config_dynamics('W:/Connie/results/Bassi2025/fig1', 'V:\Connie\results\behavior_updated\data_info', plot_info,[]);
...
mouse_data_conditions = heatmaps_avg_combined_all_celltypes_refactored( ...
        imaging_st, plot_info, alignment,[],[info.savepath '\heatmaps'], bin_size);

%plot heatmaps and grand avg
alignment.data_type = 'dff';
mouse_data_conditions = heatmaps_avg_combined_all_celltypes_refactored( ...
        imaging_st, plot_info, alignment,[],[info.savepath '\heatmaps_dff'], bin_size);
